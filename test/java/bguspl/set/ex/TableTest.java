...
class TableTest {
    ...
    private void removeCardsAndAssert() throws InterruptedException {
        table.removeCard(1);
        table.removeCard(2);
    ...
    @Test
    void placeCard_NoSlotsAreFilled() throws InterruptedException { //our test
        placeSomeCardsAndAssert();
    }

    @Test
    void removeCard_SomeSlotsAreFilled()throws InterruptedException { //our test
        fillSomeSlots();
        removeCardsAndAssert();
    }
